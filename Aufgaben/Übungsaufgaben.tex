...
\begin{document}
\thispagestyle{fancy} \lhead{\sf \large \Fach{}} \rhead{\sf
  \Semester{}} \vspace*{0.2cm}
\begin{center}
  \LARGE \sf Übungsaufgaben zur Klausur \\
  \vspace*{0.2cm}
  \small \textit{Hinweis: Diese Aufgabensammlung deckt sicherlich nicht alle möglichen Themen ab, die in der Klausur vorkommen könnten, es genügt also sicherlich auch nicht, sich zur Vorbereitung nur diese Aufgaben anzuschauen.}
\end{center}
\vspace*{0.2cm}
Die Aufgaben sind nicht logisch angeordnet, weder was die Schwierigkeit, noch was das Thema betrifft. Fangt also nicht unbedingt mit Aufgabe 1 an, sondern sucht euch erstmal eine Aufgabe, bei der ihr euch sicher seid, dass ihr sie schafft und arbeitet euch dann Stück für Stück weiter. Die Fragen aus Aufgabe 0 solltet ihr jedoch alle problemlos beantworten können.
\\
\vspace*{0.2cm}
...
% Local Variables:
% LaTeX-command: "latex -jobname Übungsaufgaben"
% End:
